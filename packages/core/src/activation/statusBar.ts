...
export class NotebookStatusBar implements vscode.Disposable {
  ...
  constructor() {
    ...
    this.connectionItem.command = 'nexql.switchConnection';
    ...
    this.databaseItem.command = 'nexql.switchDatabase';
    ...
    this.riskIndicatorItem.command = 'nexql.showConnectionSafety';
    ...
    this.profileItem.command = 'nexql.switchConnectionProfile';
    ...
    this.workspaceDefaultItem.command = 'nexql.switchWorkspaceDefaultConnection';
  ...
  private isPostgresNotebook(editor: vscode.NotebookEditor | undefined): boolean {
    return !!editor && (
      editor.notebook.notebookType === 'nexql-notebook' ||
      editor.notebook.notebookType === 'nexql-query'
    );
  }
